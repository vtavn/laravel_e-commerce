...
class AdminHomeCategoryComponent extends Component
{
    ...
    public function updateHomeCategory()
    {
        ...
        $category->save();
        return redirect()->route('admin.homecategories')->with('message', 'Home Category updated successfully.');
    }

    public function render()
    {
        $categories = Category::all();
        return view('livewire.admin.admin-home-category-component', compact('categories'))->layout('layouts.admin');
    }
}
