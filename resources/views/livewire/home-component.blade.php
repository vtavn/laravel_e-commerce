                    ...
                    @foreach ($saleProducts as $saleProduct)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">${{$saleProduct->price}}</p></ins> <del><p class="product-price">${{$saleProduct->sale_price}}</p></del></div>
                            </div>
                        </div>
                    @endforeach
                                ...
                                @foreach ($lastProducts as $lastProduct)
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">${{ $lastProduct->price }}</span></div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
