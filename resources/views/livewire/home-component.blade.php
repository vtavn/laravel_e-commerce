                ...
                @foreach ($sliders as $slider)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <p class="sale-info">{{ __('Only price')}}: <span class="price">${{ $slider->price }}</span></p>
                    ...
                    @foreach ($saleProducts as $saleProduct)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">{{number_format($saleProduct->price)}}$</p></ins> <del><p class="product-price">{{number_format($saleProduct->sale_price)}}$</p></del></div>
                            </div>
                        </div>
                    @endforeach
                        ...
                        <div class="tab-content-item active" id="digital_1a">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                                @foreach ($lastProducts as $lastProduct)
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{ route('product.details', ['slug' => $lastProduct->slug]) }}" title="{{ $lastProduct->name }}">
                                                <figure><img src="{{ asset('assets/images/products') }}/{{ $lastProduct->image }}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                            </a>
                                            <div class="group-flash">
                                                <span class="flash-item new-label">{{ __('new') }}</span>
                                            </div>
                                        ...
                                        <div class="product-info">
                                            <a href="#" class="product-name"><span>{{ $lastProduct->name }}</span></a>
                                            <div class="wrap-price"><span class="product-price">{{ number_format($lastProduct->price) }}$</span></div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                                        ...
                                        @foreach ($c_products as $c_product)
                                            <div class="product product-style-2 equal-elem ">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="wrap-price"><span class="product-price">{{ number_format($c_product->price) }}$</span></div>
                                                </div>
                                            </div>
                                        @endforeach
                                </div>
