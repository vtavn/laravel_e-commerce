			...
			<div class=" main-content-area">
							...
							<ul class="products-cart">
								@foreach (Cart::instance('cart')->content() as $item)
										<li class="pr-cart-item">
											...
											@else
													<div class="price-field product-price"><p class="price">{{ $item->model->price }}{{ __('$') }}</p></div>
											@endif
											<div class="quantity">
											...
											<div class="price-field sub-total"><p class="price">{{ $item->subtotal(0) }}{{ __('$') }}</p></div>
											<div class="delete">
					...
					<div class="summary">
						<div class="order-summary">
							...
							<p class="summary-info"><span class="title">{{ __('Subtotal') }}</span><b class="index">{{ Cart::instance('cart')->subtotal() }}{{ __('$') }}</b></p>
							@if (Session::has('coupon'))
								<p class="summary-info"><span class="title">{{ __('Discount') }} <b>({{Session::get('coupon')['code']}})</b> <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i> </a></span><b class="index"> - {{ __('$') }}{{ $discount }}</b></p>
								<p class="summary-info"><span class="title">{{ __('Tax') }} ({{config('cart.tax')}}%)</span><b class="index">{{$taxAfterDiscount}}{{ __('$') }}</b></p>
								<p class="summary-info"><span class="title">{{ __('Subtotal with Discount') }}</span><b class="index">{{$subtotalAfterDiscount}}{{ __('$') }}</b></p>
								<p class="summary-info total-info "><span class="title">{{ __('Total') }}</span><b class="index">{{$totalAfterDiscount}}{{ __('$') }}</b></p>
							@else
								<p class="summary-info"><span class="title">{{ __('Tax') }}</span><b class="index">{{ Cart::instance('cart')->tax() }} {{ __('$') }}</b></p>
								<p class="summary-info total-info "><span class="title">{{ __('Total') }}</span><b class="index">{{ Cart::instance('cart')->total() }} {{ __('$') }}</b></p>
							@endif
						</div>
