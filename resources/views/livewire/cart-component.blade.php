			...
			<div class=" main-content-area">
							...
							<ul class="products-cart">
								@foreach (Cart::instance('cart')->content() as $item)
										<li class="pr-cart-item">
											...
											@else   
													<div class="price-field product-price"><p class="price">${{ $item->model->price }}</p></div>
											@endif
											<div class="quantity">
					...
					<div class="summary">
						<div class="order-summary">
							...
							@if (Session::has('coupon'))
								<p class="summary-info"><span class="title">Discount <b>({{Session::get('coupon')['code']}})</b> <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i> </a></span><b class="index"> - ${{ $discount }}</b></p>
				...
				@else
					<div class="text-center pt-30">
						...
						<a href="/shop" class="btn btn-success">Shoping Now!</a>
					</div>
				@endif
