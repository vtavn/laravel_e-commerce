@section('title')
{{__('Search')}} - {{ config('app.name', 'Laravel') }}
@endsection
    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>{{__('Search')}}</span></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">{{__('Search')}}</h1>
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="pageSize">
                                <option value="12" selected="selected">{{ __('12 per page') }}</option>
                                <option value="16">{{ __('16 per page') }}</option>
                                <option value="32">{{ __('32 per page') }}</option>
                            </select>
                        </div>
...
{{--                            <a href="list.html" class="list-mode display-mode"><i class="fa fa-th-list"></i>List</a>--}}
                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a href="#" class="btn add-to-cart" wire:click.prevent="store({{ $product->id }}, '{{ $product->name }}', {{ $product->price }})">{{ __('Add To Cart') }}</a>
                                    </div>
                                </div>
                            </li>
                        @endforeach
            ...
            @else
                <p style="padding-top: 30px;" class="text-center">{{ __('No Products') }}</p>
            @endif
