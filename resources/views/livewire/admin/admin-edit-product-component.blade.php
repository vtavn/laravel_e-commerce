                ...
                <div class="card card-default">
                    ...
                    <form class="form-horizontal" encrypted="multipart/form-data" action=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <button type="button" class="btn btn-info" wire:click.prevent="add">{{ __('Add') }}</button>
                            </div>
                        </div>
                        ...
                        @foreach ($inputs as $key => $value)
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-danger btn-sm" wire:click.prevent="remove({{$key}})">{{ __('Remove') }}</button>
                                </div>
                            </div>
                        @endforeach
