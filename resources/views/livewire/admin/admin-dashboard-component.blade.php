                    ...
                    <div class="icon-stat">
                        <div class="row">
                            <div class="col-xs-8 text-left">
                                ...
                                <span class="icon-stat-value">{{ number_format($totalRevenue) }}$</span>
                            </div>
                    ...
                    <div class="icon-stat">
                        <div class="row">
                            <div class="col-xs-8 text-left">
                                ...
                                <span class="icon-stat-value">{{ number_format($totalSales) }}</span>
                            </div>
                            <div class="col-xs-4 text-center">
                    ...
                    <div class="icon-stat">
                        <div class="row">
                            <div class="col-xs-8 text-left">
                                ...
                                <span class="icon-stat-value">{{ number_format($todaytotalRevenue) }}$</span>
                            </div>
                            <div class="col-xs-4 text-center">
                                <i class="fa fa-dollar icon-stat-visual bg-primary"></i>
                            </div>
                    ...
                    <div class="icon-stat">
                        <div class="row">
                            <div class="col-xs-8 text-left">
                                ...
                                <span class="icon-stat-value">{{ number_format($todaytotalSales) }}$</span>
                            </div>
                            <div class="col-xs-4 text-center">
                                <i class="fa fa-gift icon-stat-visual bg-secondary"></i>
                            </div>
